...
const CartPage = ({ openCart, setopenCart }) => {
    ...
    return (
        <Inner>
            ...
            <div className="px-4 sm:px-[3vw] md:px-[2vw] lg:px-[1.5vw] min-h-screen bg-[#D6DBE0] pt-[70px] sm:pt-[80px] md:pt-[80px] lg:pt-[100px] relative z-50 flex flex-col lg:flex-row justify-between gap-5 lg:gap-[8vw] pb-[14vw] sm:pb-18 md:pb-[8vw] lg:pb-[6vw]">
                <div className="w-full lg:w-[50%] xl:w-[55%] 2xl:w-[62%] ">
                    ...
                    <div className="">
                        <div className="flex justify-between items-center lg:items-start py-2 sm:py-4 md:py-5 lg:py-7 border-b-none lg:border-b">
                            <div className="flex justify-between items-center gap-5">
                                <div className="w-[80px] sm:w-[100px] md:w-[120px]">
                                    <img
                                        className="w-full object-cover"
                                        src="https://russianmockups.shop/media/2024/12/MSC-010-700x536.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="font-font4">
                                    ...
                                    <button className="underline text-[12px] mt-2">
                                        Remove item
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between items-center lg:items-start py-2 sm:py-4 md:py-5 lg:py-7 border-b-none lg:border-b">
                            <div className="flex justify-between items-center lg:items-start gap-5">
                                <div className="w-[80px] sm:w-[100px] md:w-[120px]">
                                    <img
                                        className="w-full object-cover"
                                        src="https://russianmockups.shop/media/2024/12/MSC-003-700x1066.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="font-font4">
                ...
                <div className="w-full lg:w-[40%] xl:w-[35%] 2xl:w-[32%]">
                    ...
                    <div className="">
                        <div className="py-4 md:py-5 lg:py-4 border-b flex justify-between font-font4 text-sm md:text-base items-center">
                            {/* <h4>Add a coupon</h4> */}
                            {/* <span><img src="/Images/Icons/down-arrow.png" alt="" /></span> */}
                            {/*  */}
                                    ...
                                    >
                                        ...
                                        <div className="overflow-hidden font-font3 leading-[25px] w-full">
                                            <div className="w-full flex gap-4 items-center justify-between">
                                                <input
                                                    type="text"
                                                    className="w-full border outline-none py-2 pl-2 bg-white mt-4 lg:mt-2" placeholder="Enter code"
                                                />
