        ...
        <div className="py-[10vw] w-full relative z-50 bg-[#D6DBE0]">
            <div className="max-w-[600px] mx-auto py-2">
                <div className="flex items-center justify-center text-[78px] tracking-[-3px] font-font5 gap-16">
                    <button className={`cursor-pointer text-[#A8ACB0] duration-200 transition-all ease-in-out hover:text-black ${switchRegister==false && "border-b text-black"}`} onClick={()=>setswitchRegister(false)}>Login</button>
                    <button className={`cursor-pointer text-[#A8ACB0] duration-200 transition-all ease-in-out hover:text-black ${switchRegister && "border-b text-black"}`} onClick={()=>setswitchRegister(true)}>Register</button>
                </div>
                <div className="py-5 mt-10">
                  {switchRegister !== true ? (<div className="w-full">
                        <div className="">
                            <label className="block pb-1 font-font5 text-sm" htmlFor="">
                        ...
                        <div className="mt-4">
                            <label className="block pb-1 font-font5 text-sm" htmlFor="">Password *</label>
                            <input
                                className="w-full border outline-none rounded-[5px] py-2 pl-2 bg-white"
                                type="password"
                                name=""
                        ...
                        <div className="mt-5 flex gap-2 items-center">
                            ...
                            <label id="inputBox" className="font-font5 text-sm" htmlFor="">Remember me</label>
                        </div>
                        ...
                        <p className="text-center mt-4 font-font5 text-sm cursor-pointer">Lost your password?</p>
                    </div>):(<div className="">
                        <div className="">
                            <label className="font-font5 text-sm pb-1 block" htmlFor="">Email address *</label>
                            <input className="w-full border outline-none rounded-[5px] py-2 pl-2 bg-white" type="email" name="" id="" />
                        </div>
